...
public final class ImmutableMatrix {
    ...
    public ImmutableMatrix(double[][] matCopy){
        rows = matCopy.length;
    ...
    public static ImmutableMatrix filling(int rows, int columns) {
        ImmutableMatrix matrix1 = new ImmutableMatrix(rows, columns);
        for (int i = 0; i < rows;i++)
